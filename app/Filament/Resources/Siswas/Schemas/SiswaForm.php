    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                Section::make('Buat Tagihan Pembayaran')
                    ->description('Pilih bulan untuk membuat tagihan SPP secara otomatis.')
                    ->schema([
                        \Filament\Forms\Components\CheckboxList::make('bulan_pembayaran')
